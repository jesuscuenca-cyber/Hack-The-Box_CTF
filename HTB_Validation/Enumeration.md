...
```bash
$ sudo nmap -p- --open -sS -sC -sV --min-rate 5000 -n -Pn -A 10.129.95.235  -oG tcp_scan.xml
```
...
```bash
$ echo "10.129.95.235  Validation.htb " | sudo tee -a /etc/hosts 
```
