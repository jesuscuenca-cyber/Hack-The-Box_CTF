...
```bash
$ sudo nmap -p- --open -sS -sC -sV --min-rate 5000 -n -Pn -A 10.129.13.50 -oG tcp_scan.xml
```
...
```bash
$ echo "10.129.13.50 " | sudo tee -a /etc/hosts 
```
