...
```bash
$ sudo nmap -p- --open -sS -sC -sV --min-rate 5000 -n -Pn -A 10.129.231.170 -oX tcp_scan.xml
...
```bash
$ echo "10.129.231.170" | sudo tee -a /etc/hosts 
```

![alt text](Images/Browser.png)

First of all we can make a registration.

![alt text](Images/Register.png)

Once the account is created and access is granted, we are redirected to the dashboard.
